    ...
    public static boolean performAction(ServiceCenter serviceCenter, int _option, Scanner inputScan){
        ...
        switch(_option){
                    ...
                    while(count > 0){
                        ...
                        if( Integer.parseInt(triageLevel) <= 5 && Integer.parseInt(triageLevel) >= 1){
                            ...
                            if(count == 0)
                                ...
                                System.out.println("Enter a valid triage number between 1-5. Attempts left: " + count); 
                        }
                    }
                }
                catch(Exception e){
                    System.out.println("Enter valid triageLevel (a number).");
                }
                waitInput(inputScan);
                break;
            ...
            case 2:
                ...
                if(serviceCenter.assignAmbulanceForPatient() == null){
            ...
            case 3:
                ...
                int uId = Integer.parseInt(userInput);
                serviceCenter.assignAmbulanceForPatientById(uId);
                waitInput(inputScan);
                break;
            case 4:
                clearScreen();
                ...
                String userId = inn.nextLine();
                int posId = Integer.parseInt(userId);
                serviceCenter.checkPositionById(posId);
                waitInput(inputScan);
                break;
            case 5:
                clearScreen();
